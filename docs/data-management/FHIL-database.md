...
FHIL maintains a database of samples and their processing, sequencing, and analysis. Currently, the database lives as a cloud-hosted excel document. Request access from Anna if needed. The current structure is as follows:
